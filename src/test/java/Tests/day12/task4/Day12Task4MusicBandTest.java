...
class Day12Task4MusicBandTest {
    ...
    void transferMembers() {
        ...
        assertEquals(0, band1.getBandMembers().size(), "Участники: гр. А = 3, гр. В = 2. После объединения в группе А");
        assertEquals(5, band2.getBandMembers().size(), "Участники: гр. А = 3, гр. В = 2. После объединения в группе В");
    }
