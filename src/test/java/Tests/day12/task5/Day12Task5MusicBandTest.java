...
class Day12Task5MusicBandTest {
    ...
    void transferMembers() {
        ...
        assertEquals(0, band1.getBandMembers().size(), "Участники: гр. А = 4, гр. В = 3. После объединения в группе А");
        assertEquals(7, band2.getBandMembers().size(), "Участники: гр. А = 4, гр. В = 3. После объединения в группе В");
